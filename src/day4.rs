...
use core::str;
use std::arch::x86_64::{__m128i, __m256i, _mm256_castps_si256, _mm256_castsi256_ps, _mm256_cmpeq_epi32, _mm256_cmpeq_epi8, _mm256_load_ps, _mm256_loadu2_m128, _mm256_loadu2_m128i, _mm256_loadu_ps, _mm256_maskload_ps, _mm256_min_epi8, _mm256_movemask_epi8, _mm256_movemask_ps, _mm256_set1_epi32, _mm256_set1_epi8, _mm256_set_epi16, _mm256_shuffle_epi8, _mm_castsi128_ps, _mm_cmpeq_epi32, _mm_loadu_si128, _mm_movemask_ps, _mm_set1_epi32, _mm_set_epi16, _mm_shuffle_epi8};
...
pub unsafe fn part1_unsafe(input:&str) -> u32 {
    ...
    for row in 1..ROWS {
        ...
        let samba = _mm256_set_epi16(0x0102, 0x0304, 0x0506, 0x0708, 
                                              0x090a, 0x0b0c, 0x0d0e, 0x0fff,
        ...
        for i in 0..COLS/26 {
            ...
            */
            ...
            let mut x = _mm256_loadu2_m128i(
                b.as_ptr().offset((i*26) as isize) as *const __m128i,
                b.as_ptr().offset((i*26+13) as isize) as *const __m128i
            );

            cnt += _mm256_movemask_ps(_mm256_castsi256_ps(_mm256_cmpeq_epi32(x, _mm256_set1_epi32(0x584d4153)))).count_ones();
            cnt += _mm256_movemask_ps(_mm256_castsi256_ps(_mm256_cmpeq_epi32(x, _mm256_set1_epi32(0x53414d58)))).count_ones();
            x = _mm256_shuffle_epi8(x, samba);
            cnt += _mm256_movemask_ps(_mm256_castsi256_ps(_mm256_cmpeq_epi32(x, _mm256_set1_epi32(0x584d4153)))).count_ones();
            cnt += _mm256_movemask_ps(_mm256_castsi256_ps(_mm256_cmpeq_epi32(x, _mm256_set1_epi32(0x53414d58)))).count_ones();
            x = _mm256_shuffle_epi8(x, samba);
            cnt += _mm256_movemask_ps(_mm256_castsi256_ps(_mm256_cmpeq_epi32(x, _mm256_set1_epi32(0x584d4153)))).count_ones();
